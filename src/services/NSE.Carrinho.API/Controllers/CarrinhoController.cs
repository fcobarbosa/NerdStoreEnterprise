...
namespace NSE.Carrinho.API.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        public async Task<IActionResult> AtualizarItemCarrinho(Guid produtoId, CarrinhoItem item)
        {
            ...
            this._context.CarrinhoItens.Update(itemCarrinho);
            this._context.CarrinhoCliente.Update(carrinho);
        ...
        public async Task<IActionResult> RemoverItemCarrinho(Guid produtoId)
        {
            ...
            this._context.CarrinhoItens.Remove(itemCarrinho);
            this._context.CarrinhoCliente.Update(carrinho);
        ...
        {
            return await this._context.CarrinhoCliente
                .Include(c => c.Itens)
        ...
        private void ManipularNovoCarrinho(CarrinhoItem item)
        {
            ...
            ValidarCarrinho(carrinho);
            this._context.CarrinhoCliente.Add(carrinho);
        }
        ...
        private async Task<CarrinhoItem> ObterItemCarrinhoValidado(Guid produtoId, CarrinhoCliente carrinho, CarrinhoItem item = null)
        {
            ...
            var itemCarrinho = await this._context.CarrinhoItens
